...
$(BUILD_DIR)/test: $(BUILD_DIR)/maximum_of_array.o $(BUILD_DIR)/test.o
	$(CXX) $(CXXFLAGS) $(INCLUDED_DIR) $(BUILD_DIR)/maximum_of_array.o $(BUILD_DIR)/test.o -o $(BUILD_DIR)/test $(TEST_LIBS)

$(BUILD_DIR)/maximum_of_array.o: $(SOURCE_DIR)/maximum_of_array.cpp
